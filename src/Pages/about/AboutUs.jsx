...
const AboutUs = () => {
  return (
    <>
      <Seo
        title="О команде Project Team — миссия и контакты"
        description="Узнайте, чем занимается Project Team GGNTU: сопровождение студенческих инициатив, подготовка к конкурсам и помощь в развитии проектов."
        canonicalPath="/about-us"
        ogTitle="О команде Project Team"
        ogDescription="Project Team GGNTU помогает студентам реализовывать идеи через конкурсы, гранты и наставничество."
        ogImage="/img/LogoFoot.webp"
        ogImageAlt="Логотип Project Team GGNTU"
        structuredData={{
          "@context": "https://schema.org",
          "@type": "AboutPage",
          name: "О команде Project Team",
          url: "https://project-team.site/about-us",
          description:
            "Project Team GGNTU рассказывает о своей миссии и контактах для сотрудничества.",
        }}
      />
        ...
        <div className="who-me">
          <div className="about">
            <div className="circle-wrapper">
              <img src="/img/whome.svg" className="one-img" alt="Иконка участников команды" />
              <img src="/img/kot.jpg" className="two-img" alt="Участник Project Team" />
            </div>
            <p>
        ...
        <div className="we-doing">
          <div className="about">
            ...
            <div className="circle-wrapper">
              ...
              <img src="/img/kot.jpg" className="two-img" alt="Командная работа Project Team" />
            </div>
          </div>
        </div>
        <div className="contacts">
          <div className="about">
            ...
            <div className="ifrMap">
              <h2>Где мы?</h2>
              <iframe
                title="Местоположение команды Project Team"
